...
def main():
    for i in [10,20,30,40,50,60,70,80,90]:
        ...
        model_weight_path = "./pth_file5_500/resNet34_tracin_100.pth"
        ...
        epochs = 2
        best_acc = 0.0
        save_path = './pth_file5_500/resNet34_tracin_{}.pth'  # save_path = './resNet34_new.pth'
        ...
        for epoch in range(epochs):
            ...
            for step, data in enumerate(train_bar):
                ...
                #         torch.save(net.state_dict(), save_path.format(step))
                if (epoch == 0):
